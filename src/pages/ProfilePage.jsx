                  ...
                  <div className="divide-y divide-surface-200/50 dark:divide-white/[0.04]">
                     {accountInfo.map((item) => (
                        <div key={item.label} className="p-5 flex items-center gap-4 group cursor-pointer hover:bg-surface-50 dark:hover:bg-dark-50/50 transition-colors">
                           ...
                           <ChevronRight size={16} className="text-gray-300 opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                        </div>
                     ))}
                  </div>
               </Card>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
               ...
               <Card variant="solid" padding="none">
                  <div className="divide-y divide-surface-200/50 dark:divide-white/[0.04]">
                     ...
                     <button
                        onClick={logout}
                        className="w-full p-5 flex items-center gap-4 group hover:bg-red-50 rounded-b-lg dark:hover:bg-red-500/10 transition-colors text-left"
                     >
                        <div className="w-10 h-10 rounded-xl bg-red-500/10 text-red-500 flex items-center justify-center shrink-0 group-hover:bg-red-500/20 transition-colors">
                           <LogOut size={18} />
                        </div>
                        <div className="flex-1">
                           <p className="text-[10px] font-black text-red-400 uppercase tracking-widest leading-none mb-1.5">Security</p>
                           <p className="text-sm font-bold text-red-500">Logout from Secure Session</p>
                        </div>
